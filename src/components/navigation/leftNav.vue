<template>
  ...
  >
    <li
      ...
      :key="index"
      class="my-1 rounded text-sm last-of-type:mt-auto hover:bg-neutral-800"
    ...
    >
      ...
      >
        <div v-html="navLink.icon"></div>
        <span
          v-show="guiStore.showFullLefNavBar"
          class="hidden capitalize md:block"
          >{{ navLink.name }}</span
        ></router-link
      >
    </li>
...
<script setup>
  import { useGuiStore } from '@/stores/gui.js';
